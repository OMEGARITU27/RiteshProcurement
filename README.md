...
Login as admin and review pending approvals
Register employee/vendor and show approval workflow
Create requisition and purchase order
Approve/reject PO from manager/admin path
Login as vendor and update PO status from vendor portal
Generate and download vendor report
